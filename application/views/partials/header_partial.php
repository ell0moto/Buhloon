            ...
            <div class="header" ng-controller="HeaderPartialCtrl">
                ...
                <div modal="rewardsBox" options="opts">
                    ...
                    <div class="modal-footer">
                        <div class="dialogBox" plan-dialog-dir="5000" ng-repeat="messages in dialog"><em>{{messages.message}}</em></div>
                        <button class="btn" ng-click="closeRewards()">Close</button>
                ...
                <div modal="activityBox" options="opts">
                    ...
                    <div class="modal-footer">
                        <button class="btn" ng-click="closeActivity()">Close</button>
